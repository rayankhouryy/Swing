...
class SwingViewController: UIViewController {
    ...
    func spotifyAuthVC() {
        ...
        let authURLFull = "https://accounts.spotify.com/authorize?response_type=token&client_id=" + SpotifyCredentials.CLIENT_ID + "&scope=" + SpotifyCredentials.SCOPE + "&redirect_uri=" + SpotifyCredentials.REDIRECT_URI + "&show_dialog=false"
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "detailseg" {
            let DestView = segue.destination as! PlayViewController
...
extension SwingViewController: WKNavigationDelegate {
    ...
    func RequestForCallbackURL(request: URLRequest) {
        ...
        if requestURLString.hasPrefix(SpotifyCredentials.REDIRECT_URI) {
